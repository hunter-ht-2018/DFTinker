...
identifier copy_user =~ "^copy_from_user$|^__copy_from_user$|^__copy_from_user_inatomic1$|^__copy_in_user$|^__copy_user_zeroing$|^strncpy_from_user$";
...
|
	copy_user(exp2, src, size2)@p2
|
	strn_user(src, size2)@p2
|
	getname_user(src, ...)@p2
|
...
|
	copy_user(exp2, (T2)src, size2)@p2
|
	strn_user((T2)src, size2)@p2
|
	getname_user((T2)src, ...)@p2

)
+	spin_unlock_rtm(&lock);
	...
	}
