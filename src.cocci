...
position p1,p2;
identifier func;
identifier get_user =~ "^get_user$|^__get_user$";
identifier copy_user =~ "^copy_from_user$|^__copy_from_user$|^__copy_from_user_inatomic$|^__copy_in_user$|^__copy_user_zeroing$|^strncpy_from_user$";
identifier strn_user =~ "^memdup_user_nul$|^memdup_user$|^strnlen_user$|^strndup_user$";
identifier getname_user =~ "^getname_flags$|^getname$";
identifier get_user2 =~ "^get_user$|^__get_user$";
identifier copy_user2 =~ "^copy_from_user$|^__copy_from_user$|^__copy_from_user_inatomic$|^__copy_in_user$|^__copy_user_zeroing$|^strncpy_from_user$";
identifier strn_user2 =~ "^memdup_user_nul$|^memdup_user$|^strnlen_user$|^strndup_user$";
identifier getname_user2 =~ "^getname_flags$|^getname$";
type T1,T2;
identifier srct;
@@
	func(...){
...
|
	copy_user(exp1, src, size1)@p1
|
	strn_user(src, size1)@p1
|
	getname_user(src, ...)@p1
|
...
|
	copy_user(exp1, (T1)src, size1)@p1
|
	strn_user((T1)src, size1)@p1
|
	getname_user((T1)src, ...)@p1
...
(
	...
	get_user2(exp2, src)@p2
|
	copy_user2(exp2, src, size2)@p2
|
	strn_user2(src, size2)@p2
|
	getname_user2(src, ...)@p2
|


	get_user2(exp2, (T2)src)@p2
|
	copy_user2(exp2, (T2)src, size2)@p2
|
	strn_user2((T2)src, size2)@p2
|
	getname_user2((T2)src, ...)@p2
...
|
	copy_user(exp1, src->e1, size1)@p1
|
	strn_user(src->e1, size1)@p1
|
	getname_user(src->e1, ...)@p1
|


	get_user(exp1, (T1)src->e1)@p1
|
	copy_user(exp1, (T1)src->e1, size1)@p1
|
	strn_user((T1)src->e1, size1)@p1
|
	getname_user((T1)src->e1, ...)@p1
